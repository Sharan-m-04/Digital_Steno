...
public class AddNoteActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		imageview15.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				discard.setTitle("Go Premium");
				discard.setMessage("Features:\n-No Ads\n-OCR\n-In Note Translation\n-Save As PDF");
				discard.setPositiveButton("Buy Now At ₹79 Only", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface _dialog, int _which) {
						in.setAction(Intent.ACTION_VIEW);
						in.setData(Uri.parse("https://digitalsteno.github.io/#pricing"));
						startActivity(in);
					}
				});
				discard.create().show();
							...
							runOnUiThread(new Runnable() {
								...
								public void run() {
									...
									b2.setOnClickListener(new View.OnClickListener() {
										@Override
										public void onClick(View _view) {
											FileUtil.writeFile(FileUtil.getExternalStorageDir().concat("/Digital Steno/Saved TXT Files/".concat(e1.getText().toString().concat(".txt"))), edittext1.getText().toString());
											map = new HashMap<>();
											map.put("note", edittext1.getText().toString().trim());
											map.put("title", edittext3.getText().toString().trim());
											if (position == -1) {
...
*/
	...
	public void onStart() {
		...
		if (dm.getString("dark", "").equals("1")) {
			...
			linear19.setBackgroundColor(0xFF212121);
		}
		else {
	...
	public void _translate(final String _translate) {
		if (String.valueOf((long)(0)).equals("0")) {
			...
			if (String.valueOf((long)(0)).equals("1")) {
				...
				if (String.valueOf((long)(0)).equals("2")) {
					translator = new TranslateAPI(
									ENGLISH,
									ALBANIAN,
									_translate);
					...
					if (String.valueOf((long)(0)).equals("3")) {
						translator = new TranslateAPI(
										ENGLISH,
										ARABIC,
										_translate);
						...
						if (String.valueOf((long)(0)).equals("4")) {
							translator = new TranslateAPI(
											ENGLISH,
											ARMENIAN,
											_translate);
							...
							if (String.valueOf((long)(0)).equals("5")) {
								translator = new TranslateAPI(
												ENGLISH,
												AUTO_DETECT,
												_translate);
								...
								if (String.valueOf((long)(0)).equals("6")) {
									translator = new TranslateAPI(
													ENGLISH,
													AZERBAIJANI,
													_translate);
									...
									if (String.valueOf((long)(0)).equals("7")) {
										translator = new TranslateAPI(
														ENGLISH,
														BASQUE,
														_translate);
										...
										if (String.valueOf((long)(0)).equals("8")) {
											translator = new TranslateAPI(
															ENGLISH,
															BELARUSIAN,
															_translate);
											...
											if (String.valueOf((long)(0)).equals("9")) {
												translator = new TranslateAPI(
																ENGLISH,
																BENGALI,
																_translate);
												...
												if (String.valueOf((long)(0)).equals("10")) {
													translator = new TranslateAPI(
																	ENGLISH,
																	BULGARIAN,
																	_translate);
													...
													if (String.valueOf((long)(0)).equals("11")) {
														translator = new TranslateAPI(
																		ENGLISH,
																		CATALAN,
																		_translate);
														...
														if (String.valueOf((long)(0)).equals("12")) {
															translator = new TranslateAPI(
																			ENGLISH,
																			CHINESE,
																			_translate);
															...
															if (String.valueOf((long)(0)).equals("13")) {
																translator = new TranslateAPI(
																				ENGLISH,
																				CHINESE_SIMPLIFIED,
																				_translate);
																...
																if (String.valueOf((long)(0)).equals("14")) {
																	translator = new TranslateAPI(
																					ENGLISH,
																					CHINESE_TRADITIONAL,
																					_translate);
																	...
																	if (String.valueOf((long)(0)).equals("15")) {
																		translator = new TranslateAPI(
																						ENGLISH,
																						CROATIAN,
																						_translate);
																		...
																		if (String.valueOf((long)(0)).equals("16")) {
																			translator = new TranslateAPI(
																							ENGLISH,
																							CZECH,
																							_translate);
																			...
																			if (String.valueOf((long)(0)).equals("17")) {
																				translator = new TranslateAPI(
																								ENGLISH,
																								DANISH,
																								_translate);
																				...
																				if (String.valueOf((long)(0)).equals("18")) {
																					translator = new TranslateAPI(
																									ENGLISH,
																									DUTCH,
																									_translate);
																					...
																					if (String.valueOf((long)(0)).equals("19")) {
																						translator = new TranslateAPI(
																										ENGLISH,
																										ENGLISH,
																										_translate);
																						...
																						if (String.valueOf((long)(0)).equals("20")) {
																							translator = new TranslateAPI(
																											ENGLISH,
																											ESTONIAN,
																											_translate);
																							...
																							if (String.valueOf((long)(0)).equals("21")) {
																								translator = new TranslateAPI(
																												ENGLISH,
																												FILIPINO,
																												_translate);
																								...
																								if (String.valueOf((long)(0)).equals("22")) {
																									translator = new TranslateAPI(
																													ENGLISH,
																													FINNISH,
																													_translate);
																									...
																									if (String.valueOf((long)(0)).equals("23")) {
																										translator = new TranslateAPI(
																														ENGLISH,
																														FRENCH,
																														_translate);
																										...
																										if (String.valueOf((long)(0)).equals("24")) {
																											translator = new TranslateAPI(
																															ENGLISH,
																															GALICIAN,
																															_translate);
																											...
																											if (String.valueOf((long)(0)).equals("25")) {
																												translator = new TranslateAPI(
																																ENGLISH,
																																GEORGIAN,
																																_translate);
																												...
																												if (String.valueOf((long)(0)).equals("26")) {
																													translator = new TranslateAPI(
																																	ENGLISH,
																																	GERMAN,
																																	_translate);
																													...
																													if (String.valueOf((long)(0)).equals("27")) {
																														translator = new TranslateAPI(
																																		ENGLISH,
																																		GREEK,
																																		_translate);
																														...
																														if (String.valueOf((long)(0)).equals("28")) {
																															translator = new TranslateAPI(
																																			ENGLISH,
																																			GUJARATI,
																																			_translate);
																															...
																															if (String.valueOf((long)(0)).equals("29")) {
																																translator = new TranslateAPI(
																																				ENGLISH,
																																				HAITIAN_CREOLE,
																																				_translate);
																																...
																																if (String.valueOf((long)(0)).equals("30")) {
																																	translator = new TranslateAPI(
																																					ENGLISH,
																																					HEBREW,
																																					_translate);
																																	...
																																	if (String.valueOf((long)(0)).equals("31")) {
																																		translator = new TranslateAPI(
																																						ENGLISH,
																																						HINDI,
																																						_translate);
																																		...
																																		if (String.valueOf((long)(0)).equals("32")) {
																																			translator = new TranslateAPI(
																																							ENGLISH,
																																							HUNGARIAN,
																																							_translate);
																																			...
																																			if (String.valueOf((long)(0)).equals("33")) {
																																				translator = new TranslateAPI(
																																								ENGLISH,
																																								ICELANDIC,
																																								_translate);
																																				...
																																				if (String.valueOf((long)(0)).equals("34")) {
																																					translator = new TranslateAPI(
																																									ENGLISH,
																																									INDONESIAN,
																																									_translate);
																																					...
																																					if (String.valueOf((long)(0)).equals("35")) {
																																						translator = new TranslateAPI(
																																										ENGLISH,
																																										IRISH,
																																										_translate);
																																						...
																																						if (String.valueOf((long)(0)).equals("36")) {
																																							translator = new TranslateAPI(
																																											ENGLISH,
																																											ITALIAN,
																																											_translate);
																																							...
																																							if (String.valueOf((long)(0)).equals("37")) {
																																								translator = new TranslateAPI(
																																												ENGLISH,
																																												JAPANESE,
																																												_translate);
																																								...
																																								if (String.valueOf((long)(0)).equals("38")) {
																																									translator = new TranslateAPI(
																																													ENGLISH,
																																													KANNADA,
																																													_translate);
																																									...
																																									if (String.valueOf((long)(0)).equals("39")) {
																																										translator = new TranslateAPI(
																																														ENGLISH,
																																														KOREAN,
																																														_translate);
																																										...
																																										if (String.valueOf((long)(0)).equals("40")) {
																																											translator = new TranslateAPI(
																																															ENGLISH,
																																															LATIN,
																																															_translate);
																																											...
																																											if (String.valueOf((long)(0)).equals("41")) {
																																												translator = new TranslateAPI(
																																																ENGLISH,
																																																LATVIAN,
																																																_translate);
																																												...
																																												if (String.valueOf((long)(0)).equals("42")) {
																																													translator = new TranslateAPI(
																																																	ENGLISH,
																																																	LITHUANIAN,
																																																	_translate);
																																													...
																																													if (String.valueOf((long)(0)).equals("43")) {
																																														translator = new TranslateAPI(
																																																		ENGLISH,
																																																		MACEDONIAN,
																																																		_translate);
																																														...
																																														if (String.valueOf((long)(0)).equals("44")) {
																																															translator = new TranslateAPI(
																																																			ENGLISH,
																																																			MALAY,
																																																			_translate);
																																															...
																																															if (String.valueOf((long)(0)).equals("45")) {
																																																translator = new TranslateAPI(
																																																				ENGLISH,
																																																				MALTESE,
																																																				_translate);
																																																...
																																																if (String.valueOf((long)(0)).equals("46")) {
																																																	translator = new TranslateAPI(
																																																					ENGLISH,
																																																					NORWEGIAN,
																																																					_translate);
																																																	...
																																																	if (String.valueOf((long)(0)).equals("47")) {
																																																		translator = new TranslateAPI(
																																																						ENGLISH,
																																																						PERSIAN,
																																																						_translate);
																																																		...
																																																		if (String.valueOf((long)(0)).equals("48")) {
																																																			translator = new TranslateAPI(
																																																							ENGLISH,
																																																							POLISH,
																																																							_translate);
																																																			...
																																																			if (String.valueOf((long)(0)).equals("49")) {
																																																				translator = new TranslateAPI(
																																																								ENGLISH,
																																																								PORTUGUESE,
																																																								_translate);
																																																				...
																																																				if (String.valueOf((long)(0)).equals("50")) {
																																																					translator = new TranslateAPI(
																																																									ENGLISH,
																																																									ROMANIAN,
																																																									_translate);
																																																					...
																																																					if (String.valueOf((long)(0)).equals("51")) {
																																																						translator = new TranslateAPI(
																																																										ENGLISH,
																																																										RUSSIAN,
																																																										_translate);
																																																						...
																																																						if (String.valueOf((long)(0)).equals("52")) {
																																																							translator = new TranslateAPI(
																																																											ENGLISH,
																																																											SERBIAN,
																																																											_translate);
																																																							...
																																																							if (String.valueOf((long)(0)).equals("53")) {
																																																								translator = new TranslateAPI(
																																																												ENGLISH,
																																																												SLOVAK,
																																																												_translate);
																																																								...
																																																								if (String.valueOf((long)(0)).equals("54")) {
																																																									translator = new TranslateAPI(
																																																													ENGLISH,
																																																													SLOVENIAN,
																																																													_translate);
																																																									...
																																																									if (String.valueOf((long)(0)).equals("55")) {
																																																										translator = new TranslateAPI(
																																																														ENGLISH,
																																																														SPANISH,
																																																														_translate);
																																																										...
																																																										if (String.valueOf((long)(0)).equals("56")) {
																																																											translator = new TranslateAPI(
																																																															ENGLISH,
																																																															SWAHILI,
																																																															_translate);
																																																											...
																																																											if (String.valueOf((long)(0)).equals("57")) {
																																																												translator = new TranslateAPI(
																																																																ENGLISH,
																																																																SWEDISH,
																																																																_translate);
																																																												...
																																																												if (String.valueOf((long)(0)).equals("58")) {
																																																													translator = new TranslateAPI(
																																																																	ENGLISH,
																																																																	TAMIL,
																																																																	_translate);
																																																													...
																																																													if (String.valueOf((long)(0)).equals("59")) {
																																																														translator = new TranslateAPI(
																																																																		ENGLISH,
																																																																		TELUGU,
																																																																		_translate);
																																																														...
																																																														if (String.valueOf((long)(0)).equals("60")) {
																																																															translator = new TranslateAPI(
																																																																			ENGLISH,
																																																																			THAI,
																																																																			_translate);
																																																															...
																																																															if (String.valueOf((long)(0)).equals("61")) {
																																																																translator = new TranslateAPI(
																																																																				ENGLISH,
																																																																				TURKISH,
																																																																				_translate);
																																																																...
																																																																if (String.valueOf((long)(0)).equals("62")) {
																																																																	translator = new TranslateAPI(
																																																																					ENGLISH,
																																																																					UKRAINIAN,
																																																																					_translate);
																																																																	...
																																																																	if (String.valueOf((long)(0)).equals("63")) {
																																																																		translator = new TranslateAPI(
																																																																						ENGLISH,
																																																																						URDU,
																																																																						_translate);
																																																																		...
																																																																		if (String.valueOf((long)(0)).equals("64")) {
																																																																			translator = new TranslateAPI(
																																																																							ENGLISH,
																																																																							VIETNAMESE,
																																																																							_translate);
																																																																			...
																																																																			if (String.valueOf((long)(0)).equals("65")) {
																																																																				translator = new TranslateAPI(
																																																																								ENGLISH,
																																																																								WELSH,
																																																																								_translate);
																																																																				...
																																																																				if (String.valueOf((long)(0)).equals("66")) {
																																																																					translator = new TranslateAPI(
																																																																									ENGLISH,
																																																																									YIDDISH,
																																																																									_translate);

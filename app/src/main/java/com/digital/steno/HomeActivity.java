...
public class HomeActivity extends AppCompatActivity {
	...
	private DatabaseReference update = _firebase.getReference("app/update");
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_drawer_share_me_img = _nav_view.findViewById(R.id.share_me_img);
		_drawer_share_me = _nav_view.findViewById(R.id.share_me);
		_drawer_pro_imageview = _nav_view.findViewById(R.id.pro_imageview);
		_drawer_pro_textview = _nav_view.findViewById(R.id.pro_textview);
...
*/
		...
		_drawer_ocr_imageview.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				del.setTitle("Go Premium");
				del.setMessage("Features:\n-No Ads\n-OCR\n-In Note Translation\n-Save As PDF");
				del.setPositiveButton("Buy Now At ₹79 Only", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface _dialog, int _which) {
						in.setAction(Intent.ACTION_VIEW);
		...
		_drawer_share_me_img.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
		...
		_drawer_share_me.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				SketchwareUtil.showMessage(getApplicationContext(), "Please wait....");
				shareApplication();
		...
		_drawer_pro_imageview.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				del.setTitle("Go Premium");
				del.setMessage("Features:\n-No Ads\n-OCR\n-In Note Translation\n-Save As PDF");
		...
		_drawer_pro_textview.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				del.setTitle("Go Premium");
				del.setMessage("Features:\n-No Ads\n-OCR\n-In Note Translation\n-Save As PDF");
	...
	private void initializeLogic() {
		...
		edittext1.setOnEditorActionListener(new TextView.OnEditorActionListener() { @Override public boolean onEditorAction(TextView v, int actionId, KeyEvent event) { if(actionId ==3){ 
	...
	public void onStart() {
		...
		if (dm.getString("dark", "").equals("1")) {
			...
			linear13.setBackgroundColor(0xFF212121);
		}
		else {
